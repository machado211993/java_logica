...
public class App {
    public static void main(String[] args) throws Exception {
         ...
         * ingresen repetidos
         * usaremos un conjunto. El programa pedirá un país en un bucle, se guardará el
         * país en el
         * conjunto y después se le preguntará al usuario si quiere guardar otro país o
         * si quiere salir,
        ...
        ServicePais servicePais = new ServicePais();
        servicePais.crearPais();
        servicePais.mostrarPaises();
        servicePais.eliminarPais();
    }
}
